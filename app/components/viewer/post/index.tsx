...
export const PostViewer = ({ post }: { post: Post }) => {
  ...
  return (
    <InViewSection triggerKey={postHooks.isLoading}>
      <article className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden" style={{ display: postHooks.isLoading ? 'none' : 'block' }}>
        <div className="relative h-64 md:h-80 overflow-hidden">
            <img
              src={postHooks.image ? `data:image/jpeg;base64,${postHooks.image}` : "https://placehold.co/300x200/cccccc/cccccc.png?text=+"}
